...
TOESP_WIFI_CONNECT                    EQU 60  ; Connect to Wi-Fi if possible
...
; PING CMDS
TOESP_PING_START                      EQU 61  ; Start pinging passed hostname
TOESP_PING_GET_RESULT                 EQU 62  ; Get ping results
...
; PING CMDS
FROMESP_PING_STATUS                   EQU 29  ; Return ping status
FROMESP_PING_RESULT                   EQU 30  ; Return ping result
...
; Ping start status
RNBW_PING_START_STATUS_STARTED EQU 0
RNBW_PING_START_STATUS_BUSY EQU 1
RNBW_PING_START_STATUS_BAD_HOST EQU 2
RNBW_PING_START_STATUS_START_FAILED EQU 3
RNBW_PING_START_STATUS_MALFORMED EQU 4

; Ping result status
RNBW_PING_RESULT_STATUS_IDLE EQU 0
RNBW_PING_RESULT_STATUS_RUNNING EQU 1
RNBW_PING_RESULT_STATUS_DONE EQU 2
RNBW_PING_RESULT_STATUS_MALFORMED EQU 3
RNBW_PING_RESULT_STATUS_START_FAILED EQU 4
...
RNBW_FILE_DELETE_MALFORMED_MESSAGE EQU 4
...
RNBW_FILE_DOWNLOAD_HTTP_STATUS_NOT_OK EQU 5
RNBW_FILE_DOWNLOAD_MALFORMED_MESSAGE EQU 6
RNBW_FILE_DOWNLOAD_ERROR_WHILE_OPENING_DESTINATION_FILE EQU 7
RNBW_FILE_DOWNLOAD_FAILED_TO_CONNECT_TO_URL EQU 8
RNBW_FILE_DOWNLOAD_TCP_CONNECTION_ACTIVE EQU 9
...
RNBW_FILE_DOWNLOAD_NETWORK_ERR_NOT_ENOUGH_RAM EQU -8
RNBW_FILE_DOWNLOAD_NETWORK_ERR_TRANSFER_ENCODING_NOT_SUPPORTED EQU -9
RNBW_FILE_DOWNLOAD_NETWORK_ERR_STREAM_WRITE_ERROR EQU -10
